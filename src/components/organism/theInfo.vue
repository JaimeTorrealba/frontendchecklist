    ...
    <div class="grid gap-8 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
      <div class="flex">
        ...
        <div>
          <div class="mb-2">
            <a
              href="https://dexie.org/docs/Tutorial/Consuming-dexie-as-a-module"
              target="_blank"
              class="text-xs font-semibold tracking-wide uppercase transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800"
              aria-label="Category"
              title="Delevopment"
              >Delevopment</a
            >
      ...
      <div class="flex">
        <div class="pt-1 mr-6 text-center">
          ...
          <div class="px-2">
            <p class="text-lg font-bold">27</p>
          </div>
        </div>
        <div>
          <div class="mb-2">
